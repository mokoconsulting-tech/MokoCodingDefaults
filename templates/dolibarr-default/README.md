...
<!--
![Screenshot sample](img/screenshot_sample.png?raw=true "Sample"){imgmd}
-->
...
Clone the repository in `$dolibarr_main_document_root_alt/sample`

```shell
cd ....../custom
git clone git@github.com:gitlogin/sample.git sample
```
