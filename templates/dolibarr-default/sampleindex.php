...
$langs->loadLangs(array("sample@sample"));
...
llxHeader("", $langs->trans("SampleArea"), '', '', 0, 0, '', '', '', 'mod-sample page-index');

print load_fiche_titre($langs->trans("SampleArea"), '', 'sample.png@sample');
...
// Draft MyObject
if (isModEnabled('sample') && $user->hasRight('sample', 'read')) {
	$langs->load("orders");
